        ...
        <div className="absolute left-0 top-0 w-full h-full">
            <div className="relative flex flex-col items-center justify-center w-full h-full bg-background dark:bg-dark-background m-auto">
                <div className="w-96 bg-white dark:bg-black rounded-2xl px-2 py-4">
                    <h1 className="text-center text-xl font-normal mb-4">Register</h1>
                    <form className="w-full rounded p-4 mb-4">
                        ...
                        <div className="mb-6">
                            ...
                            <input
                                className="shadow appearance-none border border-red-500 rounded-2xl w-full py-2 px-3 text-black dark:text-white mb-3 leading-tight focus:outline-none focus:shadow-outline"
