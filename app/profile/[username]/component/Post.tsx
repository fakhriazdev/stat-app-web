...
const Post = () => {
    return (
        <div className="w-full text-black dark:text-white bg-background dark:bg-dark-background rounded-3xl p-2 mb-6">
...
/>
                ...
                <div className='w-full bg-background dark:bg-dark-background rounded-2xl p-2 mb-4'>
                    ...
                    <div className="w-full p-2 text-sm">Northwestern Medicine and Brigham and Women’s Hospital
                        scientists
                        have discovered a molecular defect that promotes the pathologic immune response in systemic
                        lupus
                        erythematosus (known as lupus) and in a study
