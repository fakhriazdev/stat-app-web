...
const Navbar = (props: { children: any; }) => {
    ...
    return (
        <>
        <section className="relative max-w-7xl flex flex-col md:flex-row gap-2 justify-between mx-auto md:px-4 lg:px-8">
            <nav className="sticky top-10 md:top-16 lg:top-16 w-full md:w-2/12 lg:2/12 md:h-44 lg:h-44 mx-auto z-40">
                <div
                    ...
                    <Link href="/profile/schacian29" className={`flex flex-col md:flex-row items-center justify-start gap-3 ${isActive('profile')}`}>
                        <div className='w-7 h-7 my-auto bg-white rounded-xl'></div>
                        <h1 className="hidden md:block lg:block text-sm">Profile</h1>
                    </Link>
                    <Link href="/" className={`flex flex-col md:flex-row items-center justify-start gap-3 ${isActive('')}`}>
                        <Home
                            size="28"
                        />
                        <h1 className="hidden md:block lg:block text-sm">Home</h1>
                    </Link>
                    <Link href="/explore" className={`flex flex-col md:flex-row items-center justify-start gap-3 ${isActive('explore')}`}>
                        <SearchNormal1
                            size="28"
                        />
